...
st.sidebar.button("About", on_click=lambda: st.write("This app demonstrates the RIWWER KI project."))
...
timeevent = st.slider("time event", min_value=MIN_LINES, max_value=MAX_LINES, key="slider1")
...
st.write(f"Filling level of rain basin for event: {vierlinden_data.iloc[timeevent]['PV_18_Fuellstand_RUEB_1_ival']}")
...
st.area_chart(vierlinden_data["PV_18_Fuellstand_RUEB_1_ival"], 
